...
namespace Samraksh.AppNote.DotNow.PingPong
{
    ...
    public class Program
    {
        ...
        private const int SendInterval = 5000; // Time to wait before sending reply
        ...
        private const int NoResponseInterval = SendInterval * 2; // Time to wait before re-sending; must be larger than send interval
        ...
        public static void Main()
        {
            ...
            _macBase.OnSendStatus += OnSendStatus;
        ...
        static void OnSendStatus(IMAC macInstance, DateTime time, SendPacketStatus ACKStatus, uint transmitDestination, ushort index)
        {
