...
namespace Samraksh_Mel.Radio
{
    ...
    /// </summary>
    public enum SX1276SpreadingFactor
    {
    ...
    /// <summary>SX1276 Radio configuration</summary>
    public class SX1276RadioConfiguration : IRadioConfiguration
    {
        /// <summary>Transmission power of the radio</summary>
        public int TxPower { get; set; }
        ...
        /// <param name="power">Transmission power</param>
        /// <param name="channel">Channel</param>
        public SX1276RadioConfiguration(SX1276TxPower power = SX1276TxPower.Power_0dBm, SX1276Channel channel = SX1276Channel.Channel_915, SX1276Bandwidth bandwidth = SX1276Bandwidth.Bandwidth_500kHz, SX1276CodingRate codingRate = SX1276CodingRate.CodingRate_4_7, SX1276SpreadingFactor spreadingFactors = SX1276SpreadingFactor.SpreadingFactor_7)
        {
            RadioName = RadioName.SX1276;
            TxPower = (int)power;
            Channel = (int)channel;
