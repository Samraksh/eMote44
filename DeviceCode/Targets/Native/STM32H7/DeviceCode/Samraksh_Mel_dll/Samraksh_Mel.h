...
struct Library_Samraksh_Mel_Samraksh_Mel_AudioInterface
{
    ...
    TINYCLR_NATIVE_DECLARE(mel_get_thresh___VOID__SZARRAY_R4);
    TINYCLR_NATIVE_DECLARE(mel_set_thresh___I4__SZARRAY_R4);
...
struct Library_Samraksh_Mel_Samraksh_Mel_UsbSerialInterface
{
    ...
    static const int FIELD__DataReceived = 4;
...
struct Library_Samraksh_Mel_Samraksh_Mel_MelUtility
{
    TINYCLR_NATIVE_DECLARE(GetMelStatus___STATIC__I4__SZARRAY_I4);
