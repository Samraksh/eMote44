...
namespace Samraksh_Mel
{
    struct MACBase
    {
        ...
        static INT32& Get_MACType( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_INT32( pMngObj, Library_Samraksh_Mel_Samraksh_Mel_MACBase::FIELD__MACType ); }

        static UNSUPPORTED_TYPE& Get_MACRadioObj( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_UNSUPPORTED_TYPE( pMngObj, Library_Samraksh_Mel_Samraksh_Mel_MACBase::FIELD__MACRadioObj ); }
