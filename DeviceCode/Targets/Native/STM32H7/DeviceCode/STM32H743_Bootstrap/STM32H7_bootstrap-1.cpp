...
*/
    ...
    #define RCC_CFGR_PPRE1_DIV_BITS RCC_D2CFGR_D2PPRE1_DIV1
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB1_CLOCK_HZ * 2
    #define RCC_CFGR_PPRE1_DIV_BITS RCC_D2CFGR_D2PPRE1_DIV2
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB1_CLOCK_HZ * 4
    #define RCC_CFGR_PPRE1_DIV_BITS RCC_D2CFGR_D2PPRE1_DIV4
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB1_CLOCK_HZ * 8
    #define RCC_CFGR_PPRE1_DIV_BITS RCC_D2CFGR_D2PPRE1_DIV8
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB1_CLOCK_HZ * 16
    #define RCC_CFGR_PPRE1_DIV_BITS RCC_D2CFGR_D2PPRE1_DIV16
#else
    #error SYSTEM_CYCLE_CLOCK_HZ must be SYSTEM_APB1_CLOCK_HZ * 1, 2, 4, 8, or 16
#endif

#if SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB2_CLOCK_HZ * 1
    #define RCC_CFGR_PPRE2_DIV_BITS RCC_D2CFGR_D2PPRE2_DIV1
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB2_CLOCK_HZ * 2
    #define RCC_CFGR_PPRE2_DIV_BITS RCC_D2CFGR_D2PPRE2_DIV2
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB2_CLOCK_HZ * 4
    #define RCC_CFGR_PPRE2_DIV_BITS RCC_D2CFGR_D2PPRE2_DIV4
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB2_CLOCK_HZ * 8
    #define RCC_CFGR_PPRE2_DIV_BITS RCC_D2CFGR_D2PPRE2_DIV8
#elif SYSTEM_CYCLE_CLOCK_HZ == SYSTEM_APB2_CLOCK_HZ * 16
    #define RCC_CFGR_PPRE2_DIV_BITS RCC_D2CFGR_D2PPRE2_DIV16
#else
...
void __section("SectionForBootstrapOperations") STM32H7_BootstrapCode()
{
	...
	MODIFY_REG(RCC->D1CFGR, RCC_D1CFGR_D1CPRE, RCC_D1CFGR_HPRE_DIV1);
    ...
    // not found in H7 RCC->APB1ENR = RCC_APB1ENR_PWREN;    // PWR clock used for sleep
    ...
    //RCC->CR &= ~(RCC_CR_PLL1ON);//| RCC_CR_PLLI2SON); // pll off
...
//#endif
    ...
    //FLASH->ACR = FLASH_ACR_LATENCY_BITS;// FLASH_ACR_ARTEN | FLASH_ACR_PRFTEN | FLASH_ACR_LATENCY_BITS; 

    // setup PLL
	//RCC->PLL1DIVR = ( (((__PLLN1__) - 1U )& RCC_PLL1DIVR_N1) | ((((__PLLP1__) -1U ) << 9U) & RCC_PLL1DIVR_P1) | \
                                ((((__PLLQ1__) -1U) << 16U)& RCC_PLL1DIVR_Q1) | ((((__PLLR1__) - 1U) << 24U)& RCC_PLL1DIVR_R1) );
	//RCC->PLLCFGR = RCC_PLL1VCOWIDE;
	//RCC->PLLCFG = RCC_PLL1VCIRANGE_3;
	//RCC->CR = RCC_CR_PLL1ON;
    ...
    // final clock setup
    //RCC->CFGR = RCC_CFGR_SW_PLL1;  // sysclk = pll out (SYSTEM_CLOCK_HZ)
	

	 
   //RCC->D1CFGR = RCC_CFGR_HPRE_DIV_BITS;  // AHB clock
    //RCC->D2CFGR = RCC_CFGR_PPRE1_DIV_BITS; // APB1 clock
    //RCC->D2CFGR = RCC_CFGR_PPRE2_DIV_BITS; // APB2 clock
...
//#ifdef STM32H7_Enable_RTC
//    STM32H7_RTC_Initialize(); // enable RTC
//#endif
}
