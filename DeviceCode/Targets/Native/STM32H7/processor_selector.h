...
#ifndef _STM32H7_PROCESSOR_SELECTOR_H_
#define _STM32H7_PROCESSOR_SELECTOR_H_ 1

#define PLATFORM_ARM_DEFINED

#if defined(PLATFORM_ARM_STM32H7)
#define STM32H7XX
#else
ERROR - WE SHOULD NOT INCLUDE THIS HEADER IF NOT BUILDING AN STM32H7 PLATFORM
#endif
