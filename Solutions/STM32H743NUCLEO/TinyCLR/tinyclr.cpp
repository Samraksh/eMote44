...
*/
	...
	VirtTimer_SetTimer(VIRT_TIMER_TIME_TEST, 0, 100000, FALSE, FALSE, Timer_1_Handler); 
	//VirtTimer_SetTimer(VIRT_TIMER_TIME_TEST, 0, 1000000, FALSE, FALSE, Timer_Green_Handler); 
	VirtTimer_Start(VIRT_TIMER_TIME_TEST);
	VirtTimer_SetTimer(VIRT_TIMER_RTC_TEST, 0, 200000, FALSE, FALSE, Timer_RTC_Handler, LOW_DRIFT_TIMER);
